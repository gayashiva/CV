...
\cventry{September 2018--Present}{PhD student}{Artificial Ice Reservoirs}{}{}{Developed a weather based physical model
to predict meltwater discharge and an automation system to improve construction of Artificial Ice Reservoirs (AIRs, also called icestupas).
This PhD project is funded via the Swiss Government Excellence Scholarship } \begin{flushright}
  \href{https://orcid.org/0000-0002-8027-8808}{[{\color{blue}View Publications}]}
\end{flushright}
...
about the MortAlive and Ice Stupa projects } 
%\begin{flushright}
